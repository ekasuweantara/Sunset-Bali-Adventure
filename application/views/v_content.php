  ...
  <body>
	...
	<div class="container">
		...
		<div class="col-lg-6 wow fadeInLeft" data-wow-offset="0" data-wow-delay="0.5s">
			<img src="<?php echo base_url('/assets/images/5.jpg'); ?>" class="img-responsive" >
		</div>
	</div>
		...
		<div class="container">
			<div class="text-center">
				...
				<div class="wow fadeInRight" data-wow-offset="0" data-wow-delay="0.3s">
					<div class="col-md-3">
						<img src="<?php echo base_url('/assets/images/about/man4.jpg'); ?>" alt="" >
						<h3>John Doe</h3>
				...
				<div class="wow fadeInRight" data-wow-offset="0" data-wow-delay="0.6s">
					<div class="col-md-3">
						<img src="<?php echo base_url('/assets/images/about/man2.jpg'); ?>" alt="" >
						<h3>John Doe</h3>
						<p>Lorem ipsum dolor sit amet consectetur adipisicing eil sed deiusmod tempor</p>
					</div>
				</div>
				...
				<div class="wow fadeInLeft" data-wow-offset="0" data-wow-delay="0.3s">
					<div class="col-md-3">
						<img src="<?php echo base_url('/assets/images/about/man3.jpg'); ?>" alt="" >
						<h3>John Doe</h3>
						<p>Lorem ipsum dolor sit amet consectetur adipisicing eil sed deiusmod tempor</p>
					</div>
				</div>
